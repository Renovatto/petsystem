<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h3 class="page-title">
                Editar <?php echo $this->data['Pet']['nome'] ?> <small>alteração de todos os detalhes do pet</small>
            </h3>
    ...
    <div class="portlet box light-grey">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('Pet', array('action' => 'editar', 'class' => 'horizontal-form')) ?>
...
<!--                            <input type="text" id="nome" name="" class="form-control input-group-lg" placeholder="nome completo">-->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo $this->Form->input('nascimento', array('id' => 'mask_date', 'type' => 'text', 'label' => false, 'value' => $this->Formatacao->data($this->data['Pet']['nascimento']), 'class' => 'form-control input-sm', 'placeholder' => '15/07/2005')); ?>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <?php
                        echo $this->Form->select('cliente_id', $listClientes, array('class' => 'form-control select2me', 'empty' => __('- Selecione o Proprietário -')));
                        ?>
                    </div>

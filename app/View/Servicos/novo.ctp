...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h3 class="page-title">
                Novo Serviço <small>informe todos os detalhes do serviço</small>
            </h3>
    ...
    <div class="portlet box light-grey">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('Servico', array('action' => 'novo', 'class' => 'horizontal-form')) ?>

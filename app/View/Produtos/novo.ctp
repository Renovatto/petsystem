...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h3 class="page-title">
                Novo Produto <small>informe todos os detalhes do produto</small>
            </h3>
    ...
    <div class="portlet box light-grey">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo $this->Form->create('Produto', array('action' => 'novo', 'class' => 'horizontal-form')) ?>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo $this->Form->input('valor_compra', array('label' => false, 'class' => 'form-control input-sm', 'placeholder' => 'valor nf compra')); ?>
                        </div>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo $this->Form->input('valor_venda', array('label' => false, 'class' => 'form-control input-sm', 'placeholder' => 'valor normal venda')); ?>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label"><?php echo __('Valor Promoção') ?></label>
                            <?php echo $this->Form->input('valor_promocao', array('label' => false, 'class' => 'form-control input-sm', 'placeholder' => 'venda promoção')); ?>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label"><?php echo __('Valor Promoção') ?> 2</label>
                            <?php echo $this->Form->input('valor_promocao2', array('label' => false, 'class' => 'form-control input-sm', 'placeholder' => 'venda promoção 2')); ?>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label"><?php echo __('Valor Promoção') ?> 3</label>
                            <?php echo $this->Form->input('valor_promocao3', array('label' => false, 'class' => 'form-control input-sm', 'placeholder' => 'venda promoção 3')); ?>
                        </div>
                    </div>
                </div>

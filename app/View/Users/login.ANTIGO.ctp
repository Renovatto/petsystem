<?php
//TITULO DA PAGINA
//$this->assign('title', 'Login | Acesso ao Sistema');
?>
<!-- BEGIN LOGO -->
<div class="logo">
    <?php
    echo $this->Html->image("logo-big.png");
    ?>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    ...
    <?php echo $this->Form->create('User', array('url' => array('controller' => 'users', 'action' => 'login'), 'class' => 'login-form')); ?>
    <!--    <form class="login-form" action="/petsystem" method="post">-->
    ...
    <div class="create-account">
        <p>
            ...
            <a href="javascript:;" id="register-btn" >Solicite aqui</a>
        </p>
    </div>
</form>
<!-- END LOGIN FORM -->
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
    2014 &copy; PetSystem by renovas. CakePHP <?php echo Configure::version() ?>
</div>
<!-- END COPYRIGHT -->
